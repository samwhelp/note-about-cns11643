...
function __main__()
{
	...
	console.log(cnsgroup_dec_to_hex('1')); // 1
	console.log(cnsgroup_dec_to_hex('11')); // b
	console.log(cnsgroup_dec_to_hex('19')); // 13


	console.log();


	console.log(cnscode_find_group_and_point('1-5678'));
	console.log(cnscode_find_group_and_point('15678'));


	console.log();


	console.log(cnspart_to_hex('1', '5678')); // 15678
	console.log(cnspart_to_dec('1', '5678')); // 87672
	...
	console.log(cnscode_to_hex('1-5678')); // 15678
	console.log(cnscode_to_dec('1-5678')); // 87672
	...
	console.log(cnscode_to_hex('11-2121')); // b2121
	console.log(cnscode_to_dec('11-2121')); // 729377
	...
	console.log(cnscode_to_hex('19-2121')); // 132121
	console.log(cnscode_to_dec('19-2121')); // 1253665
